<template>
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Arsip Kelas</h1>
        </div>
...
export default {
  ...
  methods: {
    fetchData() {
      let dataFetchUrl = `${this.url}/api/kelas?page=${this.currentPage}&search=${this.search}&order=${this.sortedColumn}&by=${this.order}&limit=${this.perPage}&status=n`
