<template>
  <div class="container">
  	<div class="page-header">
       <h1 class="page-title">Laporan Clock Piket</h1>
    </div>
        ...
        <div class="card-body" style="padding:0 !important;">
          ...
          <div v-else class="laporan-clock">
            <div class="laporan-clock-title">
              <h3>TABEL KEHADIRAN GURU PIKET</h3>
  ...
  methods: {
    ...
    downloadExcel(){
      ...
      axios.post(window.location.origin + "/api/laporan/clock",{
        bulan:moment(this.bulan).format('MMMM'),tanggal:this.bulan,data:JSON.stringify(this.clockData),piket:true
      }).then(response => {
    ...
    fetchData() {
      axios.get(window.location.origin + "/api/laporan/clock/piket?tanggal="+this.bulan)
           .then(response => {               
