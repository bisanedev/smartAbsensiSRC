                            ...
                            <table class="table table-striped table-vcenter text-nowrap card-table">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th class="text-center w-1" @click="sortByColumn('urut')">
                                        No Absensi
                                        <span v-if="'urut' === sortedColumn">
                                        <i v-if="order === 'asc' " class="fe fe-arrow-up"></i>
                                        <i v-else class="fe fe-arrow-down"></i>
                                        </span>
                                        </th>
                                        ...
                                        <th class="text-center">
                                          <a type="button" style="margin-left: 13px;color: #fff;" :class="{notactive: disable}" @click="MultiSelect()"><i class="fe fe-grid"></i>
                                          </a>
                                        </th>
                                    </tr>
                                </thead>
                                        ...
                                        <td class="text-center">
                                            <div class="item-action dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <button type="button" @click="uploadModal(data)" class="dropdown-item" ><i class="fe fe-image"></i> Foto 
                                                    </button>
...
export default {
  ...
  methods: {
    fetchData() {      
      let dataFetchUrl = `${this.url}/api/siswa?page=${this.currentPage}&search=${this.search}&order=${this.sortedColumn}&by=${this.order}&limit=${this.perPage}`
                ...
                .then(response => {                
                  ...
                  { 
                    ...
                    this.$notify({
                      ...
                      title: 'Delete Sukses',
                      type: 'success',
                      text: 'Data Siswa '+username+' Berhasil Di Hapus'
                    });  
                  }
                })
                .catch(error => {
