                                    ...
                                    <tr v-else v-for="(data, key1) in tableData" :key="data.id">
                                        ...
                                        <td class="text-center">
                                            <div class="item-action dropdown">
                                                <a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-grid"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <button type="button" @click="resetModal(data)" class="dropdown-item"><i class="fe fe-lock"></i> 
                                                    Change Password 
                                                    </button>
                                                </div>
                                            </div>
...
export default {
  ...
  methods: {
    fetchData() {
      let dataFetchUrl = `${this.url}/api/users?page=${this.currentPage}&search=${this.search}&order=${this.sortedColumn}&by=${this.order}&limit=${this.perPage}`
                ...
                .then(response => {                
                  ...
                  { 
                    ...
                    this.$notify({
                      ...
                      title: 'Delete Sukses',
                      type: 'success',
                      text: 'Data Guru/Admin '+username+' Berhasil Di Hapus'
                    });  
                  }
                })
                .catch(error => {
